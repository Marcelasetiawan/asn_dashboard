...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pegawai', function (Blueprint $table) {
            ...
            $table->string('nama', 150);                // "Nama"
            $table->string('jenis_kelamin', 5)->nullable();   // "L/P"
            $table->string('status', 30)->nullable();          // "Status"
            $table->string('golongan_ruang', 10)->nullable();  // "Gol. Ruang"
            $table->string('tmt_pangkat', 20)->nullable();     // "TMT Pangkat"
            $table->string('eselon', 20)->nullable();          // "Eselon"
            $table->string('jabatan', 200)->nullable();        // "Jabatan"
            $table->string('tmt_jabatan', 20)->nullable();     // "TMT Jabatan"
            $table->string('agama', 20)->nullable();           // "Agama"
            $table->string('satuan_kerja', 200)->nullable();   // "Satuan Kerja"
